...
export const legacyWorkstations = [
  ...
  { file: 'signal-bridge.html', job: 'E2EE WebSocket signal bridge and packet pinger', to: '/tools/sovereign-agent-bridge' },
  { file: 'bus-monitor.html', job: 'Loopback bus channels and mesh latency', to: '/tools/sovereign-agent-bridge' },
  { file: 'netrunner-memory.html', job: 'Biomorphic STDP memory daemon and vector search', to: '/memory' },
  { file: 'consensus.html', job: 'Socratic debate arena and AST diff console', to: '/arsenal' },
  { file: 'fusion-arena.html', job: 'Multi-model fusion arbitration', to: '/arsenal' },
  ...
  { file: 'connectors.html', job: 'Tool and model connector directory', to: '/arsenal' },
  { file: 'subsweep.html', job: 'Subdomain recon, now subsweep-lead-scanner', to: '/tools/subsweep-lead-scanner' },
  { file: 'omnipost.html', job: 'Cross-post scheduler, now omnipost-social-engine', to: '/tools/omnipost-social-engine' },
  ...
  { file: 'ax-powerhouse.html', job: 'Agent-experience and answer-engine surfaces', to: '/ax' },
  { file: 'math-pillars.html', job: 'Six math pillars and the learning academy', to: '/docs/math' },
];
