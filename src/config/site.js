...
export const siteConfig = {
  ...
  description: 'Zoth Studio v2 is an air-gapped, zero-egress development environment for autonomous AI agents, featuring biomorphic STDP memory, Lucy Netrunner Oracle, Byzantine consensus triangulation, sovereign developer cockpits, and 27 micro-tools.',
  author: 'NullAI Tech',
  ...
  routes: {
    ...
    '/workstations': {
      title: 'Workstations // Sovereign Studio Cockpits & Developer IDEs',
      description: 'Curated directory of sovereign studio cockpits and IDEs: DAG Pipeline Composer, Cyberpunk HUD, Code IDE, Brand Sigils, and AI Model Foundry.',
